...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Web Application",
      image: fixel_magic,
      description: "An autonomous, checkout-free store powered by computer vision, enabling seamless shopping without traditional checkout counters. I was responsible for developing approximately 75% of the front-end interface.",
    ...
    },
    {
      ...
      description: "An admin dashboard for managing the JustMove fitness mobile application, featuring race tracking, user statistics, and content management. I independently developed 100% of the front-end implementation.",
